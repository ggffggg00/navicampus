...
import ru.borisof.navicampus.core.api.model.GraphNodeModel;
...
import ru.borisof.navicampus.core.dao.repo.GraphEdgeRepo;
import ru.borisof.navicampus.core.dao.repo.GraphNodeRepo;
...
public class NaviGraphStoreServiceImpl implements NaviGraphStoreService {
    ...
    private GraphNode toEntity(GraphNodeModel graphNodeModel, Building building, int floor) {
        return GraphNode.builder()
                .id(UUID.randomUUID())
                .building(building)
                .floor(floor)
                .x(graphNodeModel.xPosition())
                .y(graphNodeModel.yPosition())
                .build();
    }
